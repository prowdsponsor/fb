...
import Control.Monad.Trans.Resource (MonadThrow, MonadResourceBase)
...
-- JSON value.
asJson :: (MonadThrow m, A.FromJSON a) =>
...
fbhttp :: (C.MonadResource m, MonadResourceBase m) =>
          H.Request m
